...
const std::map<std::string, TestFunction> TEST_MAP = {
    ...
    {"PokemonHome_MasterBoxLayout", std::bind(image_void_detector_helper, test_pokemonHome_MasterBoxLayout, _1)},
    {"PokemonHome_MasterBoxRouter", std::bind(image_void_detector_helper, test_pokemonHome_MasterBoxRouter, _1)},
    {"PokemonHome_MasterPlanner", std::bind(image_void_detector_helper, test_pokemonHome_MasterPlanner, _1)},
    ...
    {"PokemonHome_DexSlots", std::bind(image_void_detector_helper, test_pokemonHome_DexSlots, _1)},
    {"PokemonHome_MasterRouterV3", std::bind(image_void_detector_helper, test_pokemonHome_MasterRouterV3, _1)},
    {"PokemonHome_PlannerV3", std::bind(image_void_detector_helper, test_pokemonHome_PlannerV3, _1)},
